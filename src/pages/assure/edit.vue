                                    ...
                                    <div class="row q-col-gutter-x-md">
                                        ...
                                        <div class="col-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 col-12">
                                                    <div class="q-mb-sm">
                                                        <q-uploader-input show-uploaded-files :max-files="5" :max-file-size="3" accept=".jpg,.png,.gif,.jpeg,.docx,.doc,.xls,.xlsx,.pdf" :multiple="false" delete-icon="clear" style="width:100%" label="Choisissez des fichiers ou déposez des fichiers ici" upload-path="fileuploader/upload/pieces_jointes" v-model="formData.pieces_jointes"  ></q-uploader-input>
