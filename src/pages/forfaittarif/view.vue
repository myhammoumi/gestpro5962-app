                                ...
                                <div class="q-pa-md">
                                    ...
                                    <div  class=" row q-col-gutter-xs justify-start q-ma-md">
                                        <template v-if="auth.canView('')">
                                            <div><q-btn icon="edit" label="Edit"  outline  :rounded="false"  no-caps  unelevated   padding="xs" color="positive" title="Modifier"  @click="app.openPageDialog({ page:'forfaittarif/edit', url: `/forfaittarif/edit/${item.id}` , closeBtn: true })">
                                            </q-btn></div>
                                        </template>
                                        <template v-if="auth.canView('')">
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'forfaittarifview',
		},
		apiPath: {
			type: String,
			default: 'forfaittarif/view',
		},
		autoLoad: {
			type: Boolean,
			default: true,
