                    ...
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/notes/add`" class="full-width" >
                ...
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-6">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/notes"></q-breadcrumbs-el>
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.noteslistheader" 
                            :rows="records"
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="titre" :props="props">
                                        {{ props.row.titre }}
                                    </q-td>
                                    <q-td key="btnactions" :props="props" >
                                        <div class="row q-col-gutter-xs justify-end">
                                            <template v-if="auth.canView('notes')">
                                                <div><q-btn icon="visibility"   outline  :rounded="false"  no-caps  unelevated   padding="xs" color="primary" title="Vue"  @click="app.openPageDialog({ page:'notes/view', url: `/notes/view/${props.row.id_note}` , closeBtn: true, width: '300px' })">
                                                </q-btn></div>
                                            </template>
                                            <template v-if="auth.canManage('notes', props.row.user_id)">
                                                <div><q-btn icon="delete_sweep"   outline  :rounded="false"  no-caps  unelevated   padding="xs" color="negative" title="Effacer"  @click="deleteItem(props.row.id_note)">
                                                </q-btn></div>
                                            </template>
                                        </div>
                                    </q-td>
