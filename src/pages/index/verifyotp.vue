					...
					<q-card-section>
						<q-banner>
							...
							<div class="row justify-between q-col-gutter-md">
								<div class="col">
									<div class="text-h6 text-bold">Vérification OTP</div>
								</div>
								<div class="col-auto">
									<div class="text-h6 text-bold text-info">{{ countDown }}</div>
								</div>
							</div>
							<div class="text-body2 text-grey-6">OTP a été envoyé à votre numéro de téléphone par SMS</div>
						</q-banner>
						<q-form ref="observer" @submit.prevent="startOtpValidation()" >
							<div class="row justify-between q-col-gutter-md">
								<div class="col">
									<q-input dense class="text-center" outlined placeholder="Entrez OTP" v-model="otpCode" required="required" type="text" input-class="text-center text-left otp-input" />
								</div>
								<div class="col-auto">
