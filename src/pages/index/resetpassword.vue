        ...
        <div class="row justify-center">
            <div class="col col-md-4">
				<q-card  flat bordered class="q-my-lg">
                    <q-card-section>
                        <div class="q-my-md">
                            <div class="text-h5 text-bold">Gestionnaire de réinitialisation de mot de passe</div>
                        </div>
                        <q-form ref="observer" @submit.prevent="submitForm()">
							<div class="q-my-md">
								<q-input v-model="formData.password" outlined dense placeholder="nouveau mot de passe" type="password" :error="isFieldValid('password')" :error-message="getFieldError('password')" />
							</div>
							<div class="q-my-md">
								<q-input v-model="formData.confirm_password" outlined dense placeholder="Confirmer le nouveau mot de passe" type="password" :error="isFieldValid('confirm_password')" :error-message="getFieldError('confirm_password')" />
							</div>
