...
<script setup>
	...
	const formDefaultValues = Object.assign({
		login: "", email: "", nom: "", prenom: "", date_naissance: new Date(), entreprise: "", infos: "", telephone: "", adresse: "", date_cteck: new Date(), date_vmedi: new Date(), date_fc: new Date(), date_rev_taxi_m: new Date(), user_role_id: "", 
	}, props.pageData);
