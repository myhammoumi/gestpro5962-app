                    ...
                    <div class="row justify-between items-center q-col-gutter-md">
                        ...
                        <div  class="col-md-auto col-12 " >
                            <template v-if="auth.canView('')">
                                <q-btn       :rounded="false"  size=""  color="primary" no-caps  unelevated   :to="`/pec/add`" class="full-width" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-6">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/pec"></q-breadcrumbs-el>
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="id" :props="props">
                                        <q-btn padding="xs"   :rounded="false"  color="primary"  no-caps  unelevated   flat :to="`/pec/view/${props.row.id}`">{{ props.row.id }}</q-btn>
                                    </q-td>
                                    ...
                                    <q-td key="btnactions" :props="props" >
                                        <div class="row q-col-gutter-xs justify-end">
                                            <template v-if="auth.canView('pec')">
                                                <div><q-btn icon="visibility" label="View"  outline  :rounded="false"  no-caps  unelevated   padding="xs" color="primary" title="Vue"  :to="`/pec/view/${props.row.id}`">
                                                </q-btn></div>
                                            </template>
                                            <template v-if="auth.canView('pec')">
