                ...
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && pageBreadCrumb.fieldName">
                                <q-card class="q-pa-md q-mb-sm text-bold nice-shadow-6">
                                    <q-breadcrumbs>
                                    <q-breadcrumbs-el icon="arrow_back" class="text-capitalize" :label="pageBreadCrumb.fieldName" to="/roles"></q-breadcrumbs-el>
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.roleslistheader" 
                            :rows="records"
                                    ...
                                    <q-td key="btnactions" :props="props" >
                                        <div class="row q-col-gutter-xs justify-end">
                                            <template v-if="auth.canView('roles')">
                                                <div><q-btn icon="visibility" label="View"  outline  :rounded="false"  no-caps  unelevated   padding="xs" color="primary" title="Vue"  :to="`/roles/view/${props.row.role_id}`">
                                                </q-btn></div>
                                            </template>
                                            <template v-if="auth.canView('roles')">
                                                <div><q-btn icon="edit" label="Edit"  outline  :rounded="false"  no-caps  unelevated   padding="xs" color="positive" title="Modifier"  :to="`/roles/edit/${props.row.role_id}`">
                                                </q-btn></div>
                                            </template>
                                            <template v-if="auth.canView('roles')">
                                                <div><q-btn icon="delete_sweep" label="Delete"  outline  :rounded="false"  no-caps  unelevated   padding="xs" color="negative" title="Effacer"  @click="deleteItem(props.row.role_id)">
                                                </q-btn></div>
                                            </template>
                                        </div>
                                    </q-td>
