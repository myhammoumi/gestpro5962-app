                ...
                <div class="row q-col-gutter-x-md">
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            ...
                            :bordered="false"
                            :columns="app.menus.coursesannexes4adminheader" 
                            :rows="records"
                            ...
                            <template v-slot:body="props">
                                <q-tr :class="{selected: isCurrentRecord(props.row)}" :props="props">
                                    ...
                                    <q-td  key="user_id" :props="props">
                                        <q-btn v-if="props.row.user_id" @click="app.openPageDialog({ page: 'utilisateurs/view', url: `/utilisateurs/view/${props.row.user_id}` , closeBtn: true, width: '50%' })" padding="xs" flat color="primary" no-caps >
                                            <q-icon name="visibility" size="xs"  class="q-mr-xs"></q-icon>  {{ props.row.utilisateurs_entreprise }}
                                        </q-btn>
                                    </q-td>
                                            ...
                                            <q-btn icon="menu" padding="xs" round flat color="grey">
                                                <q-menu auto-close transition-show="flip-right"  transition-hide="flip-left" self="center middle" anchor="center middle">
                                                    <q-list dense rounded nav>
                                                        ...
                                                        <template v-if="auth.canView('courses')">
                                                            <q-item link clickable v-ripple :to="`/courses/edit_admin/${props.row.id_annexe}`">
                                                                <q-item-section>
...
<script setup>
	...
	const props = defineProps({
		...
		pageStoreKey: {
			type: String,
			default: 'COURSES-ANNEXES4_ADMIN',
		},
		pageName : {
			type : String,
			default : 'courses',
